...
def init_odoo_agent():
    INIT_SCRIPT = """
    vdb_instance {ODOO_SYSTEM_TOOLS} dim={ODOO_TOOL_EMBED_DIM} max_elements=60 M=16 ef_construction=300
    ## Main Tools
...
async def stream_chat_tests(req: ChatRequest):
    ...
    llm_instance <sysp> instname n_predict=24 temperature=0.5 force=true 
