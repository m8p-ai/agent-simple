...
def init_odoo_agent():
    INIT_SCRIPT = """
    vdb_instance {ODOO_SYSTEM_TOOLS} dim={ODOO_TOOL_EMBED_DIM} max_elements=60 M=129 ef_construction=350
    ## Main Tools
...
async def stream_chat_tests(req: ChatRequest):
    ...
    vdb_search {ODOO_SYSTEM_TOOLS} <curr> <match> distance=0.6
